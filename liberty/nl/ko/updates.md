...
### 2018년 2월 13일: Liberty 빌드팩 v3.18 업데이트
* 월별 Liberty 런타임 버전이 2018.2.0.0으로 업데이트되었습니다. 
* 기본 Liberty 런타임에는 [PI90804 Apache Commons iFix]( http://www-01.ibm.com/support/docview.wss?uid=swg22011428)도 포함됩니다. 

### 2018년 1월 31일: Liberty 빌드팩 v3.17.1 업데이트
* Liberty 기능 microProfile-1.2가 포함되도록 빌드팩이 업데이트되었습니다. 

### 2018년 1월 26일: Liberty 빌드팩 v3.17 업데이트
...
* [App Management 유틸리티](/docs/manageapps/app_mng.html)에서 사용되는 Node.js 런타임은 6.13.0 버전으로 업데이트되었습니다.
...
* [App Management 유틸리티](/docs/manageapps/app_mng.html)에서 사용되는 Node.js 런타임은 6.10.0 버전으로 업데이트되었습니다.
...
* [devconsole 및 shell App Management 유틸리티](/docs/manageapps/app_mng.html#app_management)에서 사용되는 Node.js 런타임이 최신 `0.12.17` 버전으로 업데이트되었습니다.
...
* 빌드팩에는 애플리케이션 상태 검사 및 [App Management](/docs/manageapps/app_mng.html) 기능과 관련된 많은 [Diego ![외부 링크 아이콘](../../icons/launch-glyph.svg "외부 링크 아이콘")](https://docs.cloudfoundry.org/concepts/diego/diego-architecture.html) 개선사항이 포함됩니다.
...
* [App Management](/docs/manageapps/app_mng.html) 기능이 연합 인증을 지원하도록 업데이트되었습니다. 또한, `devconsole` 및 `shell` 유틸리티에서 사용되는 Node.js 런타임이 최신 `0.12.15` 버전으로 업데이트되었습니다.
...
* [devconsole 및 shell App Management 유틸리티](/docs/manageapps/app_mng.html#app_management)에서 사용되는 Node.js 런타임이 최신 0.12.13 버전으로 업데이트되었습니다.
...
* [devconsole 및 shell App Management 유틸리티](/docs/manageapps/app_mng.html#app_management)에서 사용되는 Node.js 런타임이 최신 0.12.12 버전으로 업데이트되었습니다.
...
* 또한 빌드팩에서 여러 성능 개선사항 및 최적화 기능도 제공합니다.
  ...
  * 드롭릿(droplet) 크기를 줄이려면 [App Management 유틸리티](/docs/manageapps/app_mng.html) devconsole 및 shell에서 재시작 대신 다시 스테이징 작업이 필요합니다.
...
* [Monitoring and Analytics 서비스](/docs/services/monana/index.html)의 서비스 플러그인은 서비스에 대해 생성되는 로그의 크기를 줄일 수 있도록 업데이트되었습니다.
