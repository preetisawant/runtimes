...
<a class="xref" href="https://github.com/IBM-Cloud/get-started-php" target="_blank" title="(Download sample code)"><img class="w3-image" src="docs/runtimes/images/btn_starter-code.svg" alt="Download application code" /></a> 
