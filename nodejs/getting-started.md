...
<a class="xref" href="https://github.com/IBM-Cloud/get-started-node" target="_blank" title="(Download sample code)"><img src="runtimes/images/btn_starter-code.svg" alt="Download application code" /></a>
{: hide-in-docs}
