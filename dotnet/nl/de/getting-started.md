...
* Installieren Sie .NET Core SDK v1.0.4 von der Website [dot.net ![Symbol 'Externer Link'](../../icons/launch-glyph.svg "Symbol 'Externer Link'")](https://www.microsoft.com/net/download/core) mithilfe der Anweisungen.
...
| https://api.eu-de.bluemix.net  | Deutschland|
