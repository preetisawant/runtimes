...
Node.js buildpack V3.2-20160315-1257 到 V3.20.2-20180523-1639 支持 [FIPS ![外部链接图标](../../icons/launch-glyph.svg "外部链接图标")](https://en.wikipedia.org/wiki/Federal_Information_Processing_Standards)。  
{: shortdesc}

**不推荐使用 OpenSSL FIPS 模块：**从 Node.js buildpack V3.22 开始，OpenSSL FIPS 模块在运行时 V6.x 和 V8.x 中不再可用。仅 V4.x 继续包含 OpenSSL FIPS 模块。在 [Node.js buildpack 的最新更新](updates.html#fips-deprecation)中了解更多信息。
