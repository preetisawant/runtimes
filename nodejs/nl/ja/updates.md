...
このビルドパックには、最近 Node.js で検出されたセキュリティー脆弱性に対処する、更新された Node.js バージョンが含まれています。使用可能な最新バージョンを使用するようにアプリケーションを更新した後、Bluemix 内でアプリケーションを再ステージングします。Node.js の脆弱性についての詳細は、<a href="https://nodejs.org/en/blog/vulnerability/july-2017-security-releases/">このリンク</a>を参照してください。
