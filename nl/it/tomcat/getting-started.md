...
ibmcloud cf push
  ...
  Ci possono volere circa due minuti. Se si verifica un errore nel processo di distribuzione, puoi utilizzare il comando `ibmcloud cf logs <Your-App-Name> --recent` per risolvere il problema.
