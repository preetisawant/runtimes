...
En suivant ce tutoriel d'initiation Go, vous allez configurer un environnement de développement, déployer une application en local et sur {{site.data.keyword.Bluemix}}, puis intégrer un service de base de données {{site.data.keyword.Bluemix}} dans votre application.
...
## Etape 1 : Configurer l'environnement local et cloner l'application exemple
{: #clone}
