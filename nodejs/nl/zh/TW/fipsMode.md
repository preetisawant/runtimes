...
**OpenSSL FIPS 模組已淘汰：**在 Node.js 建置套件 3.22 版，OpenSSL FIPS 模組已不再提供於 6.x 和 8.x 版的運行環境。只有 4.x 版繼續包含 OpenSSL FIPS 模組。若要進一步瞭解，請參閱 [Node.js 建置套件的最新更新](updates.html#fips-deprecation)。
