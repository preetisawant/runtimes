...
[{{site.data.keyword.Bluemix_notm}} Local](/docs/local/index.html#local) a proxy may be configured which effects the
...
You can set these environment variables using *bluemix app env-set* or via the *manifest.yml* file.  If your application requires
