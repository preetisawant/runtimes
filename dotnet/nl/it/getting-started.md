...
* Installa l'SDK .NET Core v1.0.4 dalle istruzioni del [sito web dot.net ![Icona link esterno](../../icons/launch-glyph.svg "Icona link esterno")](https://www.microsoft.com/net/download/core).
...
| https://api.eu-de.bluemix.net  | Germania |
