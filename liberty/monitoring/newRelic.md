...
For an existing Java application to be monitored with New Relic in {{site.data.keyword.Bluemix_notm}}, follow these steps.
1. Create a New Relic service instance in {{site.data.keyword.Bluemix_notm}}.
...
2. Deploy your application to {{site.data.keyword.Bluemix_notm}} with the New Relic service.  See the following sample
...
3. Access the New Relic dashboard for your application directly from the {{site.data.keyword.Bluemix_notm}} dashboard of your application.
