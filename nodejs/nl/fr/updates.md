...
Ce pack de construction contient les versions mises à jour de Node.js qui traitent les vulnérabilités de sécurité récentes détectées dans Node.js.  Les utilisateurs doivent mettre à jour leurs applications pour utiliser les dernières versions disponibles, puis les reconstituer dans {{site.data.keyword.Bluemix_notm}}.  Consultez <a href="https://nodejs.org/en/blog/vulnerability/july-2017-security-releases/">ce lien</a> pour obtenir des détails sur les vulnérabilités de Node.js.
