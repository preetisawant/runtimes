...
" target="_blank" title="(Download sample code)"><img class="hidden" src="https://github.com/IBM-Bluemix-Docs/runtimes/tree/master/images/btn_starter-code.svg" alt="Download application code" /></a> 
