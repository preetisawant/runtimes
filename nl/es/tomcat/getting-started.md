...
ibmcloud cf push
  ...
  Esto puede tardar un par de minutos. Si hay algún error en el proceso de despliegue, puede utilizar el mandato `ibmcloud cf logs <Your-App-Name> --recent` para la resolución de problemas.
