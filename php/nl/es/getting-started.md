...
1. Visualice la app en el siguiente URL: http://localhost:8000
...
1. Desde el directorio *get-started-php*, envíe por push la app a {{site.data.keyword.Bluemix_notm}}
