...
Ruby 시작하기 튜토리얼에 따라 개발 환경을 설정하고, 앱을 로컬 및 {{site.data.keyword.Bluemix}}에 배치하고, 앱에 데이터베이스 서비스를 통합합니다.
...
rails server
  ...
  다음에서 앱을 보십시오. http://localhost:3000 이제 앱에 입력한 이름이 데이터베이스에 추가됩니다.
